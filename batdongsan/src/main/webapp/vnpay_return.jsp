...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form name="thongtinform" action="ContractController" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="vnp_OrderInfo" name="vnp_OrderInfo" id="vnp_OrderInfo" value=<%=request.getParameter("vnp_OrderInfo")%>></input>
                </div>
                <div class="form-group">
